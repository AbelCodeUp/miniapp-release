const ciConfigure = {
  ...
  bxk_wechat: {
    // 小程序appID
    appId: 'wx843075639dd2358d',
    // 应用类型 miniProgram/miniProgramPlugin/miniGame/miniGamePlugin
    type: 'miniProgram',
    // 项目下载地址
    // github: `https://github.com/AbelCodeUp/CI_mp_wexin.git`,
    ...
    storeDownloadPath: 'https://github.com:AbelCodeUp/CI_mp_wexin',
    ...
    privateKeyPath: '/server/utils/CI/private/bxk-wechart.key',
    setting: {
      es7: false,
      minify: false,
